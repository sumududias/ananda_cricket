#!/usr/bin/env python
"""
Script to fix the duplicate column migration issue
"""
import os
import sys
import django
...
def find_migration_file():
    ...
    migration_file = os.path.join(app_dir, '0003_add_college_name.py')
    ...
    if os.path.exists(migration_file):
        ...
        for filename in os.listdir(app_dir):
            if 'add_college_name' in filename and filename.endswith('.py'):
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Empty operations to skip the problematic column addition
    ]
"""
...
def fix_migration_dependencies():
    ...
    for filename in migration_files:
        ...
        try:
            ...
            if '0003_add_college_name' in filename:
                continue
                
            # Check if this migration depends on the one we modified
            if "'cricket_stats', '0003_add_college_name'" in content:
...
if __name__ == "__main__":
    print("Looking for the problematic migration file with duplicate column...")
